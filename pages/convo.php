...
<html lang="en">
  <head>
    ...
    <title>AdVenture - Conversation</title>
    <!-- Common plugins -->
  ...
  <body class="noScroll">
    <div id="convoID" style="display:none"><?= $_GET['id'] ?></div>
    <div id="convoContainer" class="convoContainer">
    </div>
    <div class="messageBox">
      <div class="space-10"></div>
      <form id="newMessage" class="boland-contact">
        <div class="col-sm-12 margin-b-20">
          <div class="form-group">
            <textarea id="newMessageText" name="message" class="form-control" rows="3" placeholder="Send a message..." maxlength="255"></textarea>
            <div class="space-10"></div>
            <div class="sendBtn"><button type="submit" class="btn btn btn-rounded btn-primary-border">Send</button></div>
          </div>
        </div>
      </form>
    </div>
    ...
    <script src="/pages/js/custom/convo.js"></script>
  </body>
</html>