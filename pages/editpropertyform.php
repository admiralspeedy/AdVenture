        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="row">
              ...
              <div class="col-sm-12 margin-b-20">
                <div class="form-group">
                  <select class="form-control" id="propertyType" name="propertyType" required>
                    <?php if($this->data['propertyType'] == "For Rent"): ?>
              ...
              <div class="col-sm-12 margin-b-20">
                <div class="form-group">
                  <textarea id="adRestrictionsPreferences" name="propertyDetails" class="form-control" rows="5" placeholder="Property Restrictions and Details" maxlength="500" required><?= $this->data['propertyDetails'] ?></textarea>
                  <label id="adRestrictionsPreferencesCharCount"><?= strlen($this->data['propertyDetails']) ?></label><label id="adRestrictionsPreferencesCharMax">/500</label>
                  <div class="help-block with-errors"></div>
                </div>
              </div>
              <div class="col-sm-12 margin-b-20">
