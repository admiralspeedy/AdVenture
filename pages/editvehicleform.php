        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="row">
              ...
              <div class="col-sm-12 margin-b-20">
                <div class="form-group">
                  <select class="form-control" id="tranType" name="tranType" required>
                    <?php if($this->data['transmission'] == "Automatic"): ?>
              ...
              <div class="col-sm-12 margin-b-20">
                <div class="form-group">
                  <input type="number" id="adPrice" name="price" class="form-control" placeholder="Price ($)" value="<?= $this->data['price'] ?>" min="1" max="1000000000" required>
                  <div class="help-block with-errors"></div>
                </div>
              </div>
              <div class="col-sm-12 margin-b-20">
                <div class="form-group">
                  <input type="text" id="adMake" name="make" class="form-control" placeholder="Manufacturer and Model" maxlength="50" value="<?= $this->data['make'] ?>" required>
                  <div class="help-block with-errors"></div>
                </div>
              </div>
              <div class="col-sm-12 margin-b-20">
                <div class="form-group">
                  <input type="number" id="adYear" name="year" class="form-control" placeholder="Year" min="1908" max="<?= intval(date('Y')) + 1; ?>" value="<?= $this->data['year'] ?>" required>
                  <div class="help-block with-errors"></div>
                </div>
              </div>
              <div class="col-sm-12 margin-b-20">
                <div class="form-group">
                  <input type="number" id="adMileage" name="mileage" class="form-control" placeholder="Kilometers" min="0" max="2000000" value="<?= $this->data['kilometers'] ?>" required>
                  <div class="help-block with-errors"></div>
                </div>
              </div>
              <div class="col-sm-12 margin-b-20">
