...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      <h3 class="text-uppercase font-400 title-font text-center margin-b-30">Latest Ads</h3>
      <div id="latestads" class="row">
      </div>
    </div>
    <div class="space-80"></div>
    <!-- Common plugins -->
    ...
    <!-- Custom JS -->
    <script src="/pages/js/custom/index.js"></script>
  </body>
</html>