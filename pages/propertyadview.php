      ...
      <div class="row">
        ...
        <div class="col-sm-5">
          <div class="item-description">
            ...
            <h3 id="propertyType"><?= $this->data['propertyType'] ?></h3>
            <div class="space-20"></div>
        ...
        <div class="col-sm-10 col-sm-offset-1">
          <div>
            <ul class="tabs-nav list-inline text-center" role="tablist">
              <li role="presentation" class="active"><a href="#vehicle" aria-controls="vehicle" role="tab" data-toggle="tab">Restrictions & Details</a></li>
