...
<html lang="en">
  ...
  <body>
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="row">
              ...
              <div class="col-sm-12 margin-b-20">
                <div class="form-group">
                  <textarea id="adRestrictionsPreferences" name="propertyDetails" class="form-control" rows="5" placeholder="Property Restrictions and Details" maxlength="500" required></textarea>
                  <label id="adRestrictionsPreferencesCharCount">0</label><label id="adRestrictionsPreferencesCharMax">/500</label>
                  <div class="help-block with-errors"></div>
                </div>
              </div>
              <div class="col-sm-12 margin-b-20">
    ...
    <script src="/pages/js/custom/propertyform.js"></script>
