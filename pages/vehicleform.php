...
<html lang="en">
  ...
  <body>
            ...
            <div class="row">
              <div class="col-sm-12 margin-b-20">
                <div class="form-group">
                  <input type="text" id="adTitle" name="title" class="form-control" placeholder="Title" maxlength="50" data-minlength="10" required>
                  <div class="help-block with-errors"></div>
                </div>
              </div>
              <div class="col-sm-12 margin-b-20">
                <div class="form-group">
                  <select class="form-control" id="tranType" name="tranType" required>
              ...
              <div class="col-sm-12 margin-b-20">
                <div class="form-group">
                  <input type="number" id="adPrice" name="price" class="form-control" placeholder="Price ($)" min="1" max="1000000000" required>
                  <div class="help-block with-errors"></div>
                </div>
              </div>
              <div class="col-sm-12 margin-b-20">
                <div class="form-group">
                  <input type="text" id="adMake" name="make" class="form-control" placeholder="Manufacturer and Model" maxlength="50" required>
                  <div class="help-block with-errors"></div>
                </div>
              </div>
              <div class="col-sm-12 margin-b-20">
                <div class="form-group">
                  <input type="number" id="adYear" name="year" class="form-control" placeholder="Year" min="1908" max="<?= intval(date('Y')) + 1; ?>" required>
                  <div class="help-block with-errors"></div>
                </div>
              </div>
              <div class="col-sm-12 margin-b-20">
                <div class="form-group">
                  <input type="number" id="adMileage" name="mileage" class="form-control" placeholder="Kilometers" min="0" max="2000000" required>
                  <div class="help-block with-errors"></div>
                </div>
              </div>
              <div class="col-sm-12 margin-b-20">
                <div class="form-group">
                  <textarea id="adDescription" name="description" class="form-control" rows="5" placeholder="Description" maxlength="500" required></textarea>
                  <label id="adDescriptionCharCount">0</label><label>/500</label>
                  <div class="help-block with-errors"></div>
                </div>
              </div>
              <div class="col-sm-12 margin-b-20">
                <div class="form-group">
                  <input id="postalcode" type="text" name="address" class="form-control" placeholder="Postal Code" data-postalcode required>
                  <div class="help-block with-errors"></div>
                </div>
              </div>
              <div class="col-sm-12 margin-b-20">
                <div class="form-group">
                  <input type="email" name="email" class="form-control" placeholder="Email Address (Displayed) (Optional)" maxlength="255">
                  <div class="help-block with-errors"></div>
                </div>
              </div>
              <div class="col-sm-12 margin-b-20">
                <div class="form-group">
                  <input type="text" name="tags" class="form-control" placeholder="Tags Separated by Commas (Tag1,Tag2,Tag3) (Optional)" maxlength="50" data-tags>
                  <div class="help-block with-errors"></div>
                </div>
              </div>
              <div class="col-sm-12 margin-b-20">
                <div class="form-group">
                  Upload images: <input type="file" id="images" name="images" accept=".png,.jpg,.jpeg" multiple required>
                  <div class="help-block with-errors"></div>
                </div>
              </div>
            </div>
    ...
    <script src="/pages/js/custom/vehicleform.js"></script>
    <script src="/pages/js/custom/postform.js"></script>
  </body>
</html>